...
export class CustomerRepository implements ICustomerRepository {
  ...
  async update(publicId: string, payload: UpdateCustomerPayload): Promise<Customer | null> {
    const customer = await this.prisma.customer.update({
      where: { publicId },
      data: {
        ...(payload.customerType !== undefined && { customerType: payload.customerType }),
        ...(payload.customerType === 'individual' && { gstin: null }),
        ...(payload.customerType === 'business' && { pan: null }),
  ...
  private mapToDomain(customer: PrismaCustomer): Customer {
    return {
      ...
      customerType: customer.customerType as Customer['customerType'],
