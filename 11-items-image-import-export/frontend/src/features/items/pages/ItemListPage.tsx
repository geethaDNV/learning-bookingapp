...
import { ImportItemsWizard } from '../components/ImportItemsWizard';
import { ItemExportMenu } from '../components/ItemExportMenu';
                ...
                list.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                      {item.image ? (
                        <img src={item.image.thumbnailDataUrl} alt={item.name} className="w-10 h-10 rounded object-cover border border-gray-200" />
                      ) : (
