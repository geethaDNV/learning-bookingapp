...
export function ItemListPage() {
  const { rows, total, page, pageSize, search, status, loading, error, setSearch, setStatus, setPage } =
    useItemsList();

  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      <h1 className="text-2xl font-semibold mb-6">Items</h1>
      <ItemFilters search={search} status={status} onSearchChange={setSearch} onStatusChange={setStatus} />
